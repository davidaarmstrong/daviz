  ...
  function(object,
    ...
    if (!is.null(names)) {
      if (length(names) == nrow(g)) {
        ...
        stop(
          paste0("mismatch between vector lengths names: (", length(names), ") and parameters: (", nrow(g), ").\n")
        )
      }
    }
  ...
  function(object,
    ...
    if (!is.null(names)) {
      if (length(names) == ncol(object)) {
        ...
        stop(
          paste0("mismatch between vector lengths names: (", length(names), ") and object: (", ncol(object), ").\n")
        )
      }
    }
  ...
  function(object,
    ...
    if (!is.null(names)) {
      if (length(names) == nrow(g)) {
        ...
        stop(
          paste0("mismatch between vector length names: (", length(names), ") and object: (", nrow(g), ").\n")
        )
      }
    }
